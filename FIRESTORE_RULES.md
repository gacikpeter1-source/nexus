...
**Based on**: `docs/10-security-rules.md`  
**Status**: Template - Deploy after Firebase configuration  

---

## 📋 Rules Overview

These security rules implement the permission system for all user roles:
- Admin
- Club Owner
- Trainer
- Assistant
...
Copy this to your `firestore.rules` file and deploy with:
```bash
...
### 1. Save Rules
Save the above rules to `firestore.rules` in your project root.
...
- Cross-club data leaks
- Orphaned child accounts
...
- **Permission System**: `src/constants/permissions.ts`
- **Permission Utils**: `src/utils/permissions.ts`
- **User Roles**: `docs/01-user-management.md`
