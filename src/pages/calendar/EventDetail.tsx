          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs mb-2">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-text-primary font-medium">
                {new Date((occurrenceDate || event.date) + 'T00:00:00').toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
              </span>
            </div>
            ...
            {event.isRecurring && event.recurrenceRule && (
              <div className="flex items-center gap-1.5 col-span-2">
                ...
                <span className="text-text-primary font-medium">
                  {event.recurrenceRule.frequency === 'daily' && `Every ${event.recurrenceRule.interval > 1 ? event.recurrenceRule.interval + ' ' : ''}day${event.recurrenceRule.interval > 1 ? 's' : ''}`}
                  {event.recurrenceRule.frequency === 'weekly' && `Every ${event.recurrenceRule.interval > 1 ? event.recurrenceRule.interval + ' ' : ''}week${event.recurrenceRule.interval > 1 ? 's' : ''}`}
                  {event.recurrenceRule.frequency === 'monthly' && `Every ${event.recurrenceRule.interval > 1 ? event.recurrenceRule.interval + ' ' : ''}month${event.recurrenceRule.interval > 1 ? 's' : ''}`}
                </span>
              </div>
            )}
          </div>
